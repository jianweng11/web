...
gulp.task('copyRecursiveVendorFiles', function () {
    ...
    var themifyicon = gulp.src(['./node_modules/ti-icons/**/*'])
        .pipe(gulp.dest('./src/assets/vendors/iconfonts/ti-icons'));
    var icheck = gulp.src(['./node_modules/icheck/skins/**/*'])
        .pipe(gulp.dest('./src/assets/vendors/icheck/skins'));
    var ionrangesliderImages = gulp.src(['./node_modules/ion-rangeslider/img/*'])
        .pipe(gulp.dest('./src/assets/vendors/img'));
    ...
    var lightgallery = gulp.src(['./node_modules/lightgallery/dist/**/*'])
        .pipe(gulp.dest('./src/assets/vendors/lightgallery'));
    var colorpickerImages = gulp.src(['./node_modules/jquery-asColorPicker/dist/images/**/*'])
        .pipe(gulp.dest('./src/assets/vendors/images'));
    var datepickerLocals = gulp.src(['./node_modules/bootstrap-datepicker/dist/locales/*.js'])
        .pipe(gulp.dest('./src/assets/vendors/datepicker-locals'));
    return merge(
        mdi,
        feathericon,
        fontawesome,
